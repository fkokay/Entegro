...
namespace Entegro.Net.Http
{
    public static class HttpClientBuilderExtensions
    {
        internal readonly static ProductInfoHeaderValue UserAgentHeader = new("Entegro", EntegroVersion.CurrentFullVersion);

        public static IHttpClientBuilder AddEntegroUserAgent(this IHttpClientBuilder builder)
        {
