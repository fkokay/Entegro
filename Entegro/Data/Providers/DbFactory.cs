...
namespace Entegro.Data.Providers
{
    ...
    public abstract class DbFactory
    {
        ...
        {
            return new[] { "Entegro.Data.SqlServer", "Entegro.Data.MySql", "Entegro.Data.PostgreSql", "Entegro.Data.Sqlite" };
        }
        ...
        public static DbFactory Load(string provider, ITypeScanner typeScanner)
        {
            ...
            return _loadedFactories.GetOrAdd(provider, key =>
            {
                ...
                {
                    case "sqlserver":
                        assemblyName = "Entegro.Data.SqlServer";
                        break;
                    case "mysql":
                        assemblyName = "Entegro.Data.MySql";
                        break;
                    case "postgresql":
                        assemblyName = "Entegro.Data.PostgreSql";
                        break;
                    case "sqlite":
                        assemblyName = "Entegro.Data.Sqlite";
                        break;
                }
