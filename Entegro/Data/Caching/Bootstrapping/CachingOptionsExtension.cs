...
namespace Entegro.Data.Caching
{
    /// <summary>
    ///     <para>
    ...
    public class CachingOptionsExtension : IDbContextOptionsExtension
    {
        ...
        private sealed class ExtensionInfo : DbContextOptionsExtensionInfo
        {
            ...
            {
                debugInfo["Entegro.Data.Caching:" + nameof(Extension.EnableLogging)] = HashCode.Combine(Extension.EnableLogging).ToString(CultureInfo.InvariantCulture);
                debugInfo["Entegro.Data.Caching:" + nameof(Extension.DefaultExpirationTimeout)] = HashCode.Combine(Extension.DefaultExpirationTimeout).ToString(CultureInfo.InvariantCulture);
                debugInfo["Entegro.Data.Caching:" + nameof(Extension.DefaultMaxRows)] = HashCode.Combine(Extension.DefaultMaxRows).ToString(CultureInfo.InvariantCulture);
            }
        }
