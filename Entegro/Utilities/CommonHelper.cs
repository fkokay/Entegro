...
namespace Entegro.Utilities
{
    public static partial class CommonHelper
    {
        ...
        public static string MapPath(string path, bool findAppRoot = true)
        {
            ...
            else
            {
                ...
                if (findAppRoot /* && !Directory.Exists(testPath)*/)
                {
                    ...
                    if (dir != null)
                    {
                        baseDirectory = Path.Combine(dir.FullName, "src", "Entegro.Web");
        ...
        private static bool IsDevEnvironmentInternal()
        {
            ...
            // if there's a 'Entegro.sln' in one of the parent folders,
        ...
        public static DirectoryInfo FindSolutionRoot(string currentDir)
        {
        ...
        {
            return File.Exists(Path.Combine(dir.FullName, "Entegro.sln"));
        }
