    ...
    return function () {
                ...
                if (null != n) {
                    ...
                    try {
                        if (r = (n = n.call(e)).next,
                            ...
                            for (; !(u = (o = r.call(n)).done) && (s.push(o.value),
                                s.length !== t); u = !0)
                                ;
                    } catch (e) {
                        l = !0,
        ...
        var d = {
                ...
                if (n) {
                    ...
                    if (o) {
                        ...
                        if ("string" == typeof o && (o = document.querySelector(o)),
                            "number" != typeof o && (o = o.getBoundingClientRect().top + i.scrollTop),
                        ...
                        if (!0 === e) {
                            var u = function () {
                                var e, n, o, l = +new Date - s, c = (e = l,
                                    n = r,
                                    o = a,
                                    (e /= t / 2) < 1 ? o / 2 * e * e + n : -o / 2 * ((e -= 1) * (e - 2) - 1) + n);
                                i.scrollTop = c,
            ...
            _findParent: function (e, t) {
                if (e && "BODY" === e.tagName.toUpperCase() || "HTML" === e.tagName.toUpperCase())
                    return null;
                for (e = e.parentNode; e && "BODY" !== e.tagName.toUpperCase() && !e.classList.contains(t);)
                    e = e.parentNode;
                return e = e && "BODY" !== e.tagName.toUpperCase() ? e : null
            },
            _triggerWindowEvent: function (e) {
                var t;
                "undefined" != typeof window && (document.createEvent ? ("function" == typeof Event ? t = new Event(e) : (t = document.createEvent("Event")).initEvent(e, !1, !0),
                    window.dispatchEvent(t)) : window.fireEvent("on".concat(e), document.createEventObject()))
            },
            ...
            _bindLayoutAnimationEndEvent: function (e, t) {
                ...
                this._transitionCallback = function (e) {
                    e.target === o && (n._unbindLayoutAnimationEndEvent(),
                        t.call(n))
                }
                    ,
            ...
            _unbindLayoutAnimationEndEvent: function () {
                ...
                this._transitionCallbackTimeout && (clearTimeout(this._transitionCallbackTimeout),
                    ...
                    t && this._transitionCallback && u.forEach((function (n) {
            ...
            _bindMenuMouseEvents: function () {
                ...
                if (!(this._menuMouseEnter && this._menuMouseLeave && this._windowTouchStart)) {
                    ...
                    this._menuMouseEnter || (this._menuMouseEnter = function () {
                        ...
                        this._windowTouchStart || (this._windowTouchStart = function (t) {
            ...
            _unbindMenuMouseEvents: function () {
                if (this._menuMouseEnter || this._menuMouseLeave || this._windowTouchStart) {
                    var e = this.getLayoutMenu();
                    this._menuMouseEnter && (e && (e.removeEventListener("mouseenter", this._menuMouseEnter, !1),
                        e.removeEventListener("touchstart", this._menuMouseEnter, !1)),
                        this._menuMouseEnter = null),
                        this._menuMouseLeave && (e && e.removeEventListener("mouseleave", this._menuMouseLeave, !1),
                            this._menuMouseLeave = null),
                        this._windowTouchStart && (e && window.addEventListener("touchstart", this._windowTouchStart, !0),
            ...
            setPosition: function () {
                ...
                this._removeClass("layout-menu-offcanvas layout-menu-fixed layout-menu-fixed-offcanvas"),
                    !e && t ? this._addClass("layout-menu-offcanvas") : e && !t ? (this._addClass("layout-menu-fixed"),
                        this._redrawLayoutMenu()) : e && t && (this._addClass("layout-menu-fixed-offcanvas"),
                            this._redrawLayoutMenu()),
                    this.update()
            },
            switchImage: function (e) {
                "system" === e && (e = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"),
                    Array.from(document.querySelectorAll("[data-app-".concat(e, "-img]"))).forEach((function (t) {
            ...
            setNavbarFixed: function () {
                this[(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("fixed")) ? "_addClass" : "_removeClass"]("layout-navbar-fixed"),
                    this.update()
            },
            setNavbar: function (e) {
                "sticky" === e ? (this._addClass("layout-navbar-fixed"),
                    this._removeClass("layout-navbar-hidden")) : "hidden" === e ? (this._addClass("layout-navbar-hidden"),
                        this._removeClass("layout-navbar-fixed")) : (this._removeClass("layout-navbar-hidden"),
                            this._removeClass("layout-navbar-fixed")),
                    this.update()
            },
            setFooterFixed: function () {
                this[(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("fixed")) ? "_addClass" : "_removeClass"]("layout-footer-fixed"),
                    this.update()
            },
            ...
            setContentLayout: function () {
                ...
                setTimeout((function () {
                    ...
                    var i, r = document.querySelector(".content-footer > div"), a = [].slice.call(document.querySelectorAll(".container-fluid")), s = [].slice.call(document.querySelectorAll(".container-xxl")), u = !1;
                    document.querySelector(".content-wrapper > .menu-horizontal > div") && (u = !0,
                        i = document.querySelector(".content-wrapper > .menu-horizontal > div")),
                        "compact" === t ? (a.some((function (e) {
                            return [o, n, r].includes(e)
                        }
                        )) && (e._removeClass("container-fluid", [o, n, r]),
                            e._addClass("container-xxl", [o, n, r])),
                            u && (e._removeClass("container-fluid", i),
                                e._addClass("container-xxl", i))) : (s.some((function (e) {
                                    return [o, n, r].includes(e)
                                }
                                )) && (e._removeClass("container-xxl", [o, n, r]),
                                    e._addClass("container-fluid", [o, n, r])),
                                    u && (e._removeClass("container-xxl", i),
            ...
            setAutoUpdate: function () {
                ...
                t && !this._autoUpdate ? (this.on("resize.Helpers:autoUpdate", (function () {
                    ...
                    this._autoUpdate = !0) : !t && this._autoUpdate && (this.off("resize.Helpers:autoUpdate"),
                        this._autoUpdate = !1)
            },
            ...
            syncCustomOptions: function (e) {
                ...
                t && (t.checked = !0,
                    window.Helpers.updateCustomOptionCheck(t))
            },
                ...
                this._initialized || (this._initialized = !0,
                    ...
                    this.on("init._Helpers", (function () {
                        e.off("resize._Helpers:redrawMenu"),
                            ...
                            "number" == typeof document.documentMode && document.documentMode < 11 && (e.off("resize._Helpers:ie10RepaintBody"),
            ...
            initPasswordToggle: function () {
                ...
                null != e && e.forEach((function (e) {
                    e.addEventListener("click", (function (t) {
                        ...
                        "text" === i.getAttribute("type") ? (i.setAttribute("type", "password"),
                            o.classList.replace("tabler-eye", "tabler-eye-off")) : "password" === i.getAttribute("type") && (i.setAttribute("type", "text"),
                                o.classList.replace("tabler-eye-off", "tabler-eye"))
                    }
                    ))
                }
                ))
            ...
            maxLengthCount: function (e, t, n) {
                ...
                t.className = "maxLength label-success",
                    i >= 0 && (t.textContent = "You typed ".concat(o, " out of ").concat(n, " characters.")),
                    i <= 0 && (t.textContent = "You typed ".concat(o, " out of ").concat(n, " characters."),
