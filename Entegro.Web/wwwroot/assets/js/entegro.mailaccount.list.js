var Entegro = Entegro || {};
Entegro.emailaccount = Entegro.emailaccount || {};

Entegro.emailaccount.list = (function ($) {

    function initList() {
        const table = $('#EmailAccountTable').DataTable({
            language: {
                paginate: {
            ...
            order: [[2, 'asc']],
            ajax: {
                url: '/EmailAccount/EmailAccountList',
                type: 'POST',
                ...
                },
                {
                    ...
                    render: (data, type, row) => `
                        <div class="d-inline-block text-nowrap">
                            <a href="/EmailAccount/Edit?id=${row.Id}" class="btn btn-text-secondary rounded-pill waves-effect btn-icon" title="Düzenle">
                            ...
                            <div class="dropdown-menu dropdown-menu-end m-0">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item text-danger delete-record" data-id="${row.Id}">Kaydı Sil</a>
                            </div>
                        </div>`
                }
            ],
                        ...
                        success: function (response) {
                            if (response.success) {
                                Swal.fire({
                                    ...
                                    table.ajax.reload(null, false); // sayfayı yenilemeden tabloyu yeniden yükle
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
