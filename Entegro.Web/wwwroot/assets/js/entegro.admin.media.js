Entegro.Admin.Media = (function () {

    class FileConflictResolutionDialog {
        constructor() {
            // Private variables.
            this._url = '/media/fileconflictresolutiondialog';
            this._dialog = null;
        ...
        _refreshFileDisplay(el, file) {
            ...
            Entegro.media.lazyLoadThumbnails(el);
    ...
    return {
        convertDropzoneFileQueue: function (queue) {
            return _.map(queue, function (dzfile) {
                ...
                var mediaType = Entegro.media.getIconHint(stub).mediaType;
