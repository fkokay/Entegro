var Entegro = Entegro || {};
Entegro.specificationAttribute = Entegro.specificationAttribute || {};

Entegro.specificationAttribute.SpecificationAttributeList = (function ($) {
    const initList = function () {
        const table = $('#SpecificationAttributeTable').DataTable({
            language: {
                paginate: {
            ...
            order: [[1, 'asc']],
            ajax: {
                url: '/SpecificationAttribute/SpecificationAttributeList',
                type: 'POST',
                ...
                },
                {
                    ...
                    render: (data, type, row) => `
                        <div class="d-inline-block text-nowrap">
                            <a href="/SpecificationAttribute/Edit?id=${row.Id}" class="btn btn-text-secondary rounded-pill waves-effect btn-icon btn-edit-specificationAttribute" title="Düzenle">
                        ...
                        buttons: [
                            ...
                            },
                            {
                                text: `<i class="icon-base ti ti-plus me-0 me-sm-1 icon-16px"></i>
                                       <span class="d-none d-sm-inline-block">Yeni Özellik</span>`,
                                className: "add-new btn btn-primary",
                                action: function () {
                                    Entegro.specificationattribute.SpecificationAttributeCreatePopup();
                                }
                            }
                        ]
                    }]
        ...
        $(document).on('click', '.delete-record', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/SpecificationAttribute/Delete',
                        type: 'POST',
                        data: { id },
