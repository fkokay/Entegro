...
let menu, animate, isHorizontalLayout = !1, SearchConfig = (document.getElementById("layout-menu") && (isHorizontalLayout = document.getElementById("layout-menu").classList.contains("menu-horizontal")),
    ...
    (() => {
        ...
        if (window.Helpers.switchImage(a),
        ...
        let r = document.querySelectorAll(".dropdown-notifications-read")
            , d = (a && a.addEventListener("click", e => {
                r.forEach(e => {
...
function loadSearchData() {
    var e = $("#layout-menu").hasClass("menu-horizontal") ? "entegro.search.json" : "entegro.search.json";
        ...
        return autocomplete({
            ...
            onStateChange({ state: e, setQuery: t }) {
                ...
                e.isOpen ? (document.body.style.overflow = "hidden",
                    ...
                    (n = document.querySelector(".aa-DetachedCancelButton")) && (n.innerHTML = '<span class="text-body-secondary">[esc]</span> <span class="icon-base icon-md ti tabler-x text-heading"></span>'),
