var Entegro = Entegro || {};
Entegro.invoice = Entegro.invoice || {};

Entegro.invoice.list = (function ($) {
    function initList() {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div class="d-inline-block text-nowrap">
                                <a href="Edit?id=${data}" class="btn btn-text-secondary rounded-pill waves-effect btn-icon" title="Düzenle">
                                ...
                                <div class="dropdown-menu dropdown-menu-end m-0">
                                    <a href="Details?id=${data}" class="dropdown-item">Detaylar</a>
                                    <div class="dropdown-divider"></div>
                                    <a href="javascript:void(0);" class="dropdown-item text-danger delete-record" data-id="${data}">Fatura Sil</a>
                                </div>
                            </div>
                        `;
                    }
                        ...
                        buttons: [
                                ...
                                buttons: [
                                    {
                                        ...
                                        exportOptions: { columns: [1, 2, 3, 4, 5, 10] }
                                    },
                                    {
                                        extend: "csv",
                                        className: "dropdown-item",
                            ...
                            },
                            {
                                text: `<i class="icon-base ti ti-plus me-0 me-sm-1 icon-16px"></i>
                                        <span class="d-none d-sm-inline-block">Yeni Fatura</span>`,
