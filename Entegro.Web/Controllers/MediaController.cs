            ...
            string entityType = "")
        {
            ...
            for (int i = 0; i < numFiles; i++)
            {
                try
                {
                    ...
                    o.path = $"{mediaFile.MediaFolder?.Name}/{mediaFile.Name}";
                    o.version = mediaFile.UpdatedOn.Ticks;
                    o.url = $"/media/{mediaFile.Id}/{mediaFile.MediaFolder?.Name}/{mediaFile.Name}";
                    o.thumbUrl = $"/media/{mediaFile.Id}/{mediaFile.MediaFolder?.Name}/{mediaFile.Name}?size=256";
                    o.lastUpdated = mediaFile.UpdatedOn;
                    o.size = mediaFile.Size;
                    o.name = mediaFile.Name;
                    o.dir = mediaFile.MediaFolder?.Name;
                ...
                catch (DuplicateMediaFileException dex)
                {
                    ...
                    o.path = $"{dupe.MediaFolder?.Name}/{dupe.Name}";
                    o.version = dupe.UpdatedOn.Ticks;
                    o.url = $"/media/{dupe.Id}/{dupe.MediaFolder?.Name}/{dupe.Name}";
                    o.thumbUrl = $"/media/{dupe.Id}/{dupe.MediaFolder?.Name}/{dupe.Name}?size=256";
                    o.lastUpdated = dupe.UpdatedOn;
                    o.size = dupe.Size;
                    o.name = dupe.Name;
                    o.dir = dupe.MediaFolder?.Name;
                    o.title = dupe.Title;
                    o.ext = dupe.Extension;
                    o.dimensions = $"{dupe.Width}, {dupe.Height}";
                    o.dupe = true;
                    o.errMessage = dex.Message;
                    o.uniquePath = $"{dupe.MediaFolder?.Name}/{dupe.Name}";
