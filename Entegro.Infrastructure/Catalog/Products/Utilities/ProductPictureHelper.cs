...
namespace Entegro.Infrastructure.Catalog.Products.Utilities
{
    public static partial class ProductPictureHelper
    {
        ...
        public static bool FixProductMainPictureId(EntegroDbContext db, Product product, IEnumerable<ProductMediaFile> entities = null)
        {
        ...
        public static Task<int> FixProductMainPictureIds(EntegroDbContext db, DateTime? ifModifiedSinceUtc = null)
        ...
        internal static async Task<int> FixProductMainPictureIds(EntegroDbContext db, bool initial, DateTime? ifModifiedSinceUtc = null)
        {
            var query =
        ...
        private static async Task<Multimap<int, int>> GetPoductPictureMap(EntegroDbContext db, IEnumerable<int> productIds)
        {
            var query =
