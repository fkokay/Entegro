...
namespace Entegro.Infrastructure.Migrations
{
    ...
    [Migration("20250905194908_OrderEdit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.OrderNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.ProductVariantAttributeValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Shipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.ShipmentItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.SpecificationAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.SpecificationAttributeOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.MediaFile", b =>
                {
                    b.HasOne("Entegro.Domain.Entities.MediaFolder", "MediaFolder")
                        .WithMany("MediaFiles")
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Order", b =>
                {
                    b.HasOne("Entegro.Domain.Entities.Address", "BillingAddress")
                        .WithMany()
                    ...
                    b.HasOne("Entegro.Domain.Entities.Address", "ShippingAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.ProductVariantAttributeValue", b =>
                {
                    b.HasOne("Entegro.Domain.Entities.ProductVariantAttribute", "ProductVariantAttribute")
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.ShipmentItem", b =>
                {
                    b.HasOne("Entegro.Domain.Entities.Shipment", "Shipment")
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Town", b =>
                {
                    b.HasOne("Entegro.Domain.Entities.City", "City")
                        .WithMany("Towns")
