...
namespace Entegro.Infrastructure.Migrations
{
    ...
    [Migration("20251218062929_edit_returnrequestitem_productimageurl")]
    partial class edit_returnrequestitem_productimageurl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Catalog.Product", b =>
                {
                    ...
                    b.Property<int?>("SourceImportProfileId")
                        .HasColumnType("int");

                    b.Property<int?>("SourceIntegrationSystemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "Deleted" }, "IX_Product_Deleted");

                    b.HasIndex(new[] { "Gtin" }, "IX_Product_Gtin");

                    b.HasIndex(new[] { "IsTransient" }, "IX_Product_IsTransient");

                    b.HasIndex(new[] { "ManufacturerPartNumber" }, "IX_Product_ManufacturerPartNumber");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.CustomerAddressMapping", b =>
                {
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.OrderItem", b =>
                {
                    ...
                    b.Property<string>("IntegrationProductImageUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.ReturnRequest", b =>
                {
                    ...
                    b.Property<long>("OrderOutboundPackageId")
                        .HasColumnType("bigint");

                    b.Property<long>("OrderShipmentPackageId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.ReturnRequestItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("AutoApproveDate")
                        .HasColumnType("datetime2");

                    b.Property<string>("Barcode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomerClaimReasonCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomerClaimReasonName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PlatformClaimReasonCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PlatformClaimReasonName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.Shipment", b =>
                {
                    ...
                    b.Property<int?>("ShippingIntegrationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShippingIntegrationId");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Import.ImportProfile", b =>
                {
                    ...
                    b.Property<bool?>("ApplyPriceAdjustment")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal?>("OptionalExtraAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("PlatformStoreMapping")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Setttings.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Scheduling.TaskDescriptor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entegro.Scheduling.TaskExecutionInfo", b =>
                {
                    ...
                    b.ToTable("ScheduleTaskHistory", (string)null);
                });
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.CustomerAddressMapping", b =>
                {
                    b.HasOne("Entegro.Domain.Entities.Common.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entegro.Domain.Entities.Common.Address", null)
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.ReturnRequestItem", b =>
                {
                    ...
                    b.HasOne("Entegro.Domain.Entities.Checkout.ReturnRequest", "ReturnRequest")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Entegro.Domain.Entities.Checkout.Shipment", b =>
                {
                    ...
                    b.HasOne("Entegro.Domain.Entities.Integration.IntegrationSystem", "ShippingIntegration")
                        .WithMany()
                        .HasForeignKey("ShippingIntegrationId");

                    b.Navigation("Order");

                    b.Navigation("ShippingIntegration");
                });
            ...
            modelBuilder.Entity("Entegro.Scheduling.TaskExecutionInfo", b =>
                {
                    b.HasOne("Entegro.Scheduling.TaskDescriptor", "Task")
