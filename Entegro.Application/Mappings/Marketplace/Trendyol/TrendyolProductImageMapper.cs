...
namespace Entegro.Application.Mappings.Marketplace.Trendyol
{
    public static class TrendyolProductImageMapper
    {
        ...
        public static ProductMediaFileDto? ToDto(TrendyolProductImageDto trendyolProductImage)
        {
        ...
        public static IEnumerable<ProductMediaFileDto> ToDtoList(IEnumerable<TrendyolProductImageDto> productImages)
        {
